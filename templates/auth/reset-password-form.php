  ...
  <div class="whoiscrm-auth-split">
    ...
    <div class="whoiscrm-auth-panel-brand">
      ...
      <div class="whoiscrm-auth-brand-inner">
        ...
        <p class="whoiscrm-auth-brand-tagline"><?php esc_html_e("You're almost back in. Set a new strong password to protect your account.", 'whois-crm'); ?></p>

        <ul class="whoiscrm-auth-trust">
          <li><?php esc_html_e('Use at least 8 characters', 'whois-crm'); ?></li>
          <li><?php esc_html_e('Mix uppercase, numbers & symbols', 'whois-crm'); ?></li>
          <li><?php esc_html_e('Password is encrypted at rest', 'whois-crm'); ?></li>
        </ul>
      </div>
    </div>
